...
# The function returns maximum circular contigous sum in
# a[]
...
# Apply kedance algo to find minimum inverted subarray 
...
print("maximum circular sum is", maxCircularSu(a))